...
<body>
	...
	<div class="signUpForm">
			...
			<form  method="post" action="submitEngineer.php" >
				...
				<input type="text"  id="phone" name="phone" placeholder="Ex:010-123-45678" class ="inputBox" pattern="[0-9]{3}[0-9]{3}[0-9]{5}" title="Only numbers alowed!" required>
				<br>				
								
				<input type = "email" id="email" name ="email" placeholder="Ex:someone@example.com" class ="inputBox"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
				<br>
				...
				<button type="submit" formaction="submitEngineer.php" class="signUp_button" id="submitbtn" name="submit"> Add Engineer </button>
				<hr>
		</form>
	</div>
